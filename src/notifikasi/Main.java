...
public class Main {
    ...
    public static void main(String[] args){
        ...
        String message = "Tutorial Polimorfisme sudah terbit di Petani Kode, cek sekrang di https://www.petanikode.com/java-oop-polimorfisme";
